...
class PartialEvaluator {
  ...
  constructor({
    ...
    options: PartialEvaluatorOptions | null
  }) {
    this.xref = xref;
  ...
  hasBlendModes(resources: Dict, nonBlendModesSet) {
  ...
  _sendImgData(objId: string, imgData, cacheGlobally = false) {
    if (PlatformHelper.isTesting() && imgData) {
  ...
  _parseVisibilityExpression(array, nestingCounter: number, currentResult: (string | string[])[]) {
  ...
  getOperatorList({
    ...
    return new Promise(function promiseBody(resolve, reject) {
      ...
      const operation: Record<string, any> = Object.create(null);
            ...
            next(
              new Promise(function (resolveXObject, rejectXObject) {
                ...
                self.getTextContent({
                  stream: xobj,
                  task,
                  resources: xobj.dict!.getValue(DictKey.Resources) || resources,
          ...
          case OPS.setGState:
            ...
            next(
              new Promise(function (resolveGState, rejectGState) {
                ...
                const gStateFont = gState.getValue(DictKey.Font);
                if (!gStateFont) {
