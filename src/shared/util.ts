...
export type OPSArgsType = {
  ...
  [OPS.setLineJoin]: number,
  [OPS.setMiterLimit]: number,
  [OPS.setDash]: number,
  ...
  [OPS.curveTo2]: number,
  [OPS.curveTo3]: number,
  [OPS.closePath]: number,
  [OPS.rectangle]: number,
  [OPS.stroke]: number,
  [OPS.closeStroke]: number,
  [OPS.fill]: number,
  [OPS.eoFill]: number,
  [OPS.fillStroke]: number,
  [OPS.eoFillStroke]: number,
  [OPS.closeFillStroke]: number,
  [OPS.closeEOFillStroke]: number,
  [OPS.endPath]: number,
  [OPS.clip]: number,
  [OPS.eoClip]: number,
  [OPS.beginText]: number,
  [OPS.endText]: number,
  [OPS.setCharSpacing]: number,
  ...
  [OPS.nextLineSetSpacingShowText]: number,
  [OPS.setCharWidth]: number,
  [OPS.setCharWidthAndBounds]: number,
  [OPS.setStrokeColorSpace]: number,
  [OPS.setFillColorSpace]: number,
  [OPS.setStrokeColor]: number,
  [OPS.setStrokeColorN]: number,
  [OPS.setFillColor]: number,
  [OPS.setFillColorN]: number,
  [OPS.setStrokeGray]: number,
  [OPS.setFillGray]: number,
  [OPS.setStrokeRGBColor]: number,
  [OPS.setFillRGBColor]: number,
  [OPS.setStrokeCMYKColor]: number,
  [OPS.setFillCMYKColor]: number,
  [OPS.shadingFill]: number,
  [OPS.beginInlineImage]: number,
  [OPS.beginImageData]: number,
  [OPS.endInlineImage]: number,
  [OPS.paintXObject]: number,
  [OPS.markPoint]: number,
  [OPS.markPointProps]: number,
  [OPS.beginMarkedContent]: number,
  [OPS.beginMarkedContentProps]: ["OC", OptionalContent | null],
  [OPS.endMarkedContent]: [],
  [OPS.beginCompat]: number,
  [OPS.endCompat]: number,
  [OPS.paintFormXObjectBegin]: [TransformType | null, RectType | null],
  [OPS.paintFormXObjectEnd]: number,
  [OPS.beginGroup]: number,
  [OPS.endGroup]: [GroupOptions],
  // beginAnnotations= 78,
  // endAnnotations= 79,
  ...
  [OPS.paintInlineImageXObjectGroup]: number,
